...
- Use patched v4
- Limit changelog trigger.
- Pin nightly
- Allow concurrent builds
- Incorrect runner name
- Add simd feature
...
- Simplify voice functions
- Propagate joined future errors
- Sqlx prepare
...
- *(chore)* Update changelog
- Revert force git
- Migrate to upstream tracing-loki
