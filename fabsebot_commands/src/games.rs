...
const RPS_CHOICES: [&str; 3] = ["rock", "paper", "scissors"];
...
pub async fn rps(
	...
	author_choice.make_ascii_lowercase();
	if !RPS_CHOICES.contains(&author_choice.as_str()) {
